...
import { Search, Sun, Moon, Monitor, Command } from 'lucide-react'
...
export function Header() {
  ...
  return (
    <header className="h-14 border-b px-6 flex items-center gap-4 shrink-0 bg-background/80 backdrop-blur-sm">
      <form onSubmit={onSearch} className="flex-1 max-w-xl">
        <div className="relative group">
          ...
          <Input
            ...
            className="pl-9 pr-20 h-9 text-[13px] bg-secondary/50 border-transparent hover:border-border focus:border-ring focus:bg-background transition-all"
          />
